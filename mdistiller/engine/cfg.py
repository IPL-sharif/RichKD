...
# RichKD CFG
CFG.RICH = CN()
CFG.RICH.MODE = "exact"  # ("exact", "relax")
CFG.RICH.FEAT = CN()
CFG.RICH.FEAT.DIM = 128
CFG.RICH.FEAT.STUDENT_DIM = 256
CFG.RICH.FEAT.TEACHER_DIM = 256
CFG.RICH.FEAT.CLIP_DIM = 768
CFG.RICH.LOSS = CN()
CFG.RICH.NCE = CN()
CFG.RICH.NCE.K = 16384
...
CFG.RICH.LOSS.LOGIT_WEIGHT = 3
CFG.RICH.LOSS.CE_WEIGHT = 1.0
CFG.RICH.LOSS.FEAT_WEIGHT = 0.8
...
CFG.CRD.TEMPERATURE = 3
CFG.CRD.LOSS.KD_WEIGHT = 3
